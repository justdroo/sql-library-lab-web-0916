def select_books_titles_and_years_in_first_series_order_by_year
  "SELECT books.title, books.year FROM books JOIN series ON 1 = books.series_id GROUP BY books.year;"
...
def select_series_title_with_most_human_characters
  ...
  WHERE characters.species = 'human' ORDER BY characters.species DESC LIMIT 1;)" #Having characters.author_id = series.author_id"
  #join??
  #GROUP BY character.species ORDER BY COUNT(character.species
end
